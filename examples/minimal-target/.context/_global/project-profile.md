...
([skill/07 §3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#3-the-project-profile)).
...
already answers. Installed skill: `hnk` 0.0.0-unreleased at commit
`f8f3a88` — the upgrade baseline.
...
([skill/07 §3.2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#32-frozen-interface--profile-body-sections)).
...
([skill/07 §6](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#6-convergence--the-one-line-proposal));
...
([skill/07 §4.3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#43-frozen-interface--defaults-by-deliverable-type)):
none

## Environment integration

Owned by
[skill/10 §4.3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/10-environment-integration.md#43-the-integration-record--frozen-interface):
...
| --- | --- | --- | --- | --- | --- |
| Claude Code | CLAUDE.md | declined | CLAUDE.md (pointer block between `hnk:begin`/`hnk:end` markers) | 2026-07-28 | https://code.claude.com/docs/en/memory (fetched at generation time; confirms ./CLAUDE.md is loaded every session; hook automation exists but the human declined wiring it for this target — the rule-based floor covers capture, raws are `reconstructed`) |
