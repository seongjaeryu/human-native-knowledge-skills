...
[human-native-knowledge-skills (`hnk`)](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/README.md).
...
([skill/10 §3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/10-environment-integration.md#3-the-contract)).
...
[D3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/core/audit.md#d--derivation-every-rule-earns-its-existence):
the frozen type enum of
[skill/03 §2.2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/03-okf.md#22-the-type-enum) defines no
...
- **R1 — Load the operating context.** Read
  ...
  (Owning specs:
  [skill/07 §8](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#8-standing-orchestrator-rules) R1;
  [skill/05 §4](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/05-dictionary-and-naming.md#4-ai-behavior) rule 1.)
- **R2 — Never re-ask what the profile answers.** If a needed Level 1 answer
  ...
  ([skill/07 §8](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#8-standing-orchestrator-rules) R2–R3, R7;
  [skill/02 §10](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/02-context-architecture.md#10-installation-and-existing-assets).)
- **R3 — Recovery sweep.** Check [../_archive/](../_archive/index.md) for
  ...
  ([skill/08 §5](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#5-the-session-lifecycle-two-stage-writing-snapshots-recovery).)
- **R4 — Minimal automatic restore, topic-keyed only.** When the session
  ...
  ([skill/08 §10](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#10-the-consumption-model);
  [skill/07 §7.3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#73-multi-session-goals).)
...
- **R5 — Record the mode explicitly; never begin under an implicit mode.**
  ...
  ([skill/07 §5](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#5-the-two-fulfillment-forms),
  [§6](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#6-convergence--the-one-line-proposal),
  [§8](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#8-standing-orchestrator-rules) R4.)
...
- **R7 — Obey the recorded autonomy level.** Before working on a topic, read
  ...
  ([skill/07 §8](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#8-standing-orchestrator-rules) R5–R6.)
...
- **R8 — Enforce the dictionary.** Silently normalize banned forms to their
  ...
  ([skill/05 §4](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/05-dictionary-and-naming.md#4-ai-behavior).)
- **R9 — Diagram first, diagram before code.** Specifications lead with
  ...
  ([skill/04 §7](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/04-diagram-first.md#7-diagram-change-control).)
- **R10 — Propose-then-confirm at the recorded level.** Under
  ...
  ([skill/07 §4.2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/07-pre-interview.md#42-the-autonomy-scale).)
- **R11 — Register binaries before referencing them.** Any visual that is
  ...
  ([skill/09 §2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/09-visual-assets.md#2-the-format-based-rule),
  [§4.2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/09-visual-assets.md#42-the-alt-field),
  [§5](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/09-visual-assets.md#5-the-reference-rule).)
- **R12 — Mandatory redaction.** Never transcribe secret values — API keys,
  ...
  ([skill/08 §7](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#7-mandatory-redaction).)
...
- **R14 — At session end:** complete the card body — Goal, Key decisions,
  ...
  ([skill/08 §4.5–4.6](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#45-card-body--frozen-interface),
  [§5](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#5-the-session-lifecycle-two-stage-writing-snapshots-recovery).)
- **R15 — Honest fidelity.** Raws you write yourself under this floor are
  ...
  `captured`.
  ([skill/08 §4.2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/08-conversation-archive.md#42-raw-fidelity-semantics--frozen-interface);
  [skill/10 §3](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/10-environment-integration.md#3-the-contract) clause ③.)
- **R16 — Living-layer sync with History Annotation.** At every milestone or
  ...
  ([skill/06 §5](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/06-lifecycle-and-versioning.md#5-living-layer-sync-with-history-annotation).)
- **R17 — Version freeze on pivots.** When a pivot is approved at the
  ...
  ([skill/06 §2](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/skill/06-lifecycle-and-versioning.md#2-git-native-freeze).)
...
- **R20 — Target audit on request.** When the human asks for an audit,
  ...
  [core/audit.md](https://github.com/seongjaeryu/human-native-knowledge-skills/blob/f8f3a88/core/audit.md) to this project:
